...
import com.ca.iso8583.gui.PnlGuiConfig;
...
public final class Main extends JFrame {
	...
	private Main() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Main.class.getResource("/com/ca/iso8583/resource/package.png")));
		setTitle("ISO8583-UI");
