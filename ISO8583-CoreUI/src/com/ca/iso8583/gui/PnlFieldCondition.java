...
import com.ca.iso8583.constants.OperatorEnum;
import com.ca.iso8583.vo.CmbItemVO;
...
public class PnlFieldCondition extends JPanel {
	...
	public PnlFieldCondition(final PnlMain pnlMain) {
		...
		btnDynaAdd.setIcon(new ImageIcon(PnlGuiConfig.class.getResource("/com/ca/iso8583/resource/enter.png")));
		...
		btnDynaValidate.setIcon(new ImageIcon(PnlGuiConfig.class.getResource("/com/ca/iso8583/resource/validate.png")));
