...
public class PnlGuiPayload extends JPanel {
	...
	private NetBeansEditorPanel xmlText = new NetBeansEditorPanel(EditorType.XML);
	...
	public PnlGuiPayload(final PnlMain pnlMain, boolean server, boolean request) {
		...
		btnUpdate.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/update.png")));
		btnSendRequest.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/enter.png")));
		btnSendResponse.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/enter.png")));
		btnOpenPayload.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/openFile.png")));
		btnSavePayload.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/saveFile.png")));
	...
	public NetBeansEditorPanel getXmlText() {
		return xmlText;
	}
}
