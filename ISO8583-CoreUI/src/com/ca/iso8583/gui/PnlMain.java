...
public class PnlMain extends JPanel {
	...
	public PnlMain() {
		...
		btnOpen.setIcon(new ImageIcon(PnlMain.class.getResource("/com/ca/iso8583/resource/openFile.png")));
		...
		btnSave.setIcon(new ImageIcon(PnlMain.class.getResource("/com/ca/iso8583/resource/saveFile.png")));
		add(btnSave);
		...
		btnNew.setIcon(new ImageIcon(PnlMain.class.getResource("/com/ca/iso8583/resource/newFile.png")));
		add(btnNew);
