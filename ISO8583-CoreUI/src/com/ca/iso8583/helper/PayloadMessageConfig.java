...
import com.ca.iso8583.gui.PnlGuiPayload;
...
import com.ca.iso8583.vo.ISOTestVO;
...
public class PayloadMessageConfig {
	...
	private class GuiPayloadField {
		...
		private GuiPayloadField(FieldVO fieldVO, FieldVO superfieldVO) {
			...
			lblDynamic.setIcon(new ImageIcon(PnlGuiPayload.class.getResource("/com/ca/iso8583/resource/search.png")));
